...
$DNI = '1234';
$productes = ($precio1, $precio2, $precio3, $precio4, $precio5, $precio6);
$ids = ($id1, $id2, $id3, $id4, $id5, $id6);

//foreach ($productes as $precio) {
//	foreach ($ids as $id) {
//		$query_insert="INSERT INTO Compras(Id, Dni, Total) VALUES ('$id','$Dni','$precio')";
